    ...
    <footer className="bg-[#1C1C1C] py-8">
      <div className="container flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <a href="https://linkedin.com" className="text-white hover:text-orange-500 transition">
        ...
        <div className="flex items-center gap-8">
          ...
          <Button className="bg-white text-black hover:bg-orange-500 hover:text-white rounded-full">
            Unlock success
          </Button>
        </div>
      </div>
